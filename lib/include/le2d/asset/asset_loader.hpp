...
class AssetLoader : public klib::Polymorphic {
  public:
	...
	explicit AssetLoader(gsl::not_null<IDataLoader const*> data_loader, gsl::not_null<IResourceFactory const*> resource_factory);
